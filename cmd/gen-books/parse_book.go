...
func (a *Article) URL() string {
	chap := a.Chapter
	book := chap.Book
	return fmt.Sprintf("/book/%s/%s/%s", book.FileNameBase, chap.FileNameBase, a.FileNameBase)
}

func (a *Article) destFilePath() string {
	chap := a.Chapter
	book := chap.Book
	return filepath.Join("books_html", "book", book.FileNameBase, chap.FileNameBase, a.FileNameBase+".html")
}
